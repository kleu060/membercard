                ...
                <div class="card-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control{{ $errors->has('organization_name') ? ' is-invalid' : '' }}" name="organization_name" id="organization_name" value="{{ old('organization_name') }}">
                        ...
                        <div class="form-group mb-2">
                            <label class="control-label" for="organization_email">Organization Email</label>
                            <input type="text" class="form-control{{ $errors->has('organization_email') ? ' is-invalid' : '' }}" name="organization_email" id="organization_email" value="{{ old('organization_email') }}">
