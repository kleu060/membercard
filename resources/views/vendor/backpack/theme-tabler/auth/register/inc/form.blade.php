...
<form role="form" method="POST" action="{{ route('backpack.auth.register') }}">
    ...
    <div class="mb-3">
        ...
        <input autofocus tabindex="5" type="text" class="form-control {{ $errors->has('organization_name') ? 'is-invalid' : '' }}" name="organization_name" id="organization_name" value="{{ old('organization_name') }}">
    ...
    <div class="mb-3">
        ...
        <input autofocus tabindex="6" type="text" class="form-control {{ $errors->has('organization_email') ? 'is-invalid' : '' }}" name="organization_email" id="organization_email" value="{{ old('organization_email') }}">
