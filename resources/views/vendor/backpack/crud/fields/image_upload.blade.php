...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="existing-file">
      <div>
          @if ( isset( $field['attributes']['thumbnailPath']) )
            <div>
              <a target="_blank" href="/{{ $field['attributes']['thumbnailPath'] }}">{{ $field['attributes']['thumbnailPath'] }}</a>
              <a href="#" class="file_clear_button btn btn-light btn-sm float-right" title="Clear file" data-filename="{{ $field['attributes']['thumbnailPath'] }}"><i class="la la-remove"></i></a>
            </div>
            <div class="thumbnail">
              <img src="{{ $field['attributes']['thumbnailPath'] }}" />
            </div> 
          @endif
      </div>
    </div>
